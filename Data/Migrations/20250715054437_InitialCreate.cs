        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClienteId = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "FreelancerServicos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FreelancerId = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    ObservacoesCliente = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreelancerServicos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FreelancerServicos_AspNetUsers_FreelancerId",
                        column: x => x.FreelancerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FreelancerServicos_Servicos_ServicoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreelancerServicos_FreelancerId_ServicoId",
                table: "FreelancerServicos",
                columns: new[] { "FreelancerId", "ServicoId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FreelancerServicos_ServicoId",
                table: "FreelancerServicos",
                column: "ServicoId");
