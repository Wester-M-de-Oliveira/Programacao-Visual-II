...
using GestaoFreela.Components;
using GestaoFreela.Components.Account;
using GestaoFreela.Data;
using GestaoFreela.Services;
...
builder.Services.AddScoped<IServicoStatusService, ServicoStatusService>();
